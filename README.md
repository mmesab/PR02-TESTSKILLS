...
<p>
Este proyecto forma parte de nuestro trabajo académico dentro del curso de desarrollo web. <br> 
Ha sido creado y desarrollado por:
</p>

<ul>
  <li><strong>Daniela Verónica</strong> — Desarrolladora web y estudiante.</li>
  <li><strong>Maite Mesa</strong> — Desarrolladora web y estudiante.</li>
</ul>

<p>
Ambas colaboramos en el diseño, documentación y construcción de las herramientas incluidas en este repositorio, combinando aprendizaje técnico con análisis psicológico aplicado.
</p>
<hr>


<h2>⭐ Apoya el proyecto</h2>
<p>Si te ha resultado interesante, puedes dejarnos una estrella ⭐</p>
